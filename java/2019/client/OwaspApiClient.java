...
public class OwaspApiClient {
    ...
    private static void testApi6() throws Exception {
        System.out.println("API6: " + post("/api6/profile", "{\"username\":\"bob\",\"is_admin\":true}"));
    }
    private static void testApi7() throws Exception {
        System.out.println("API7: " + get("/api7/debug"));
    }
    private static void testApi8() throws Exception {
        System.out.println("API8: " + post("/api8/search", "{\"q\":\"1' OR '1'='1\"}"));
    }
    ...
    private static void testApi10() throws Exception {
        System.out.println("API10: " + post("/api10/transfer", "{\"from\":\"alice\",\"to\":\"bob\",\"amount\":100}"));
    }
